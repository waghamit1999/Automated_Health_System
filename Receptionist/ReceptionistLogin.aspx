<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReceptionistLogin.aspx.cs" Inherits="MyFinalProject.ReceptionistLogin" %>
         ...
         <table class="active" align="center" style="padding: 5px;  background-color: #FFFFFF; font-family: 'Times New Roman', Times, serif; width: 397px; height: 298px;">
             <tr>
                 <td colspan="2" class="auto-style6">
                     ...
                     <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Overline="False" Text="RECPTIONIST LOGIN" Font-Names="Times New Roman" Font-Size="XX-Large"></asp:Label>
                     <br />
                     <br />
                     <br />
                 </td>
             ...
             <tr>
                 <td colspan="2" class="active" style="text-align: center">
                     ...
                     <br />
                     <asp:Button class="loghov" ID="BtnRecepLogin" runat="server" Text="LOGIN" BackColor="#000099" Font-Bold="True" Font-Size="Large" ForeColor="White" Height="40px" Width="91px" Style="border:medium solid #000099; border-radius:5px;cursor:pointer;" OnClick="BtnRecepLogin_Click" />
                     <br />
                     <br />
                 </td>
             </tr>
