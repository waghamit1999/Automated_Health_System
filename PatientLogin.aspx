<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PatientLogin.aspx.cs" Inherits="MyFinalProject.PatientLogin" %>
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
     ...
     <div class="auto-style13" style="background-color:#FFFFFF; ">
         ...
         <table class="active" align="center" style="padding: 5px;  background-color: #FFFFFF; font-family: 'Times New Roman', Times, serif; width: 397px; height: 298px;">
             <tr>
                 <td colspan="2" class="auto-style6">
                     <br /><i class="fa fa-user-plus fa-2x"></i>&nbsp;
                     <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Overline="False" Text="PATIENT LOGIN" Font-Names="Times New Roman" Font-Size="XX-Large"></asp:Label>
                     <br />
                     <br />
                     <br />
                 </td>
             ...
             <tr>
                 <td class="auto-style4">
                     <asp:Label ID="Label2" runat="server" Text="USERNAME" Font-Bold="True" Font-Names="Times New Roman" Font-Size="Large" ForeColor="#000066"></asp:Label>
                     <strong>:</strong></td>
             ...
             <tr>
                 <td class="auto-style5">
                     <asp:Label ID="Label3" runat="server" Text="PASSWORD" Font-Bold="True" Font-Names="Times New Roman" Font-Size="Large" ForeColor="#000066"></asp:Label>
                     <strong>:</strong></td>
                 <td class="auto-style7">
                     <asp:TextBox ID="TxtPatientPass" runat="server" TextMode="Password" Width="200px"></asp:TextBox>
                 </td>
             </tr>
             <tr>
                 <td colspan="2">&nbsp;</td>
             ...
             <tr>
                 <td colspan="2" class="active" style="text-align: center">
                     ...
                     <br />
                     <asp:Button class="loghov" ID="BtnPatientLogin" runat="server" Text="LOGIN" BackColor="#000099" Font-Bold="True" Font-Size="Large" ForeColor="White" Height="40px" Width="91px" Style="border:medium solid #000099; border-radius:5px;cursor:pointer;" OnClick="BtnPatientLogin_Click" />
                     <br />
                     <br />
                 </td>
             </tr>
         ...
         <table class="auto-style12">
             <tr>
                 <td class="auto-style14"><i class="fa fa-users fa-2x"></i>&nbsp;<asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Overline="False" Text="Patient Queue" Font-Names="Times New Roman" Font-Size="XX-Large"></asp:Label></td>
             </tr>
         </table>
         <br />
         <table class="auto-style15" align="center">
             <tr>
                 <td class="auto-style14">
                     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataSourceID="SqlDataSource1" GridLines="Vertical" Width="100%">
                         <AlternatingRowStyle BackColor="#DCDCDC" />
                         <Columns>
                             <asp:BoundField DataField="TokenId" HeaderText="Token Id" SortExpression="TokenId" />
                             ...
                             <asp:BoundField DataField="RecDoctor" HeaderText="Recommended Doctor" SortExpression="RecDoctor" />
                         </Columns>
             ...
             <tr>
                 <td>
                     <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:AHSConnectionString2 %>" SelectCommand="SELECT [TokenId], [Date_Time], [Name], [DOB], [RecDoctor] FROM [TempToken]"></asp:SqlDataSource>
                 </td>
             </tr>
         </table>
         <br />
