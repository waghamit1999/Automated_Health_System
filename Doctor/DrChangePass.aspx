<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DrChangePass.aspx.cs" Inherits="MyFinalProject.Doctor.DrChangePass" %>
         ...
         <table class="active" align="center" style="padding: 5px;  background-color: #FFFFFF; font-family: 'Times New Roman', Times, serif; width: 383px; height: 298px;">
             ...
             <tr>
                 <td class="auto-style4">
                     <asp:Label ID="Label2" runat="server" Text="Doctor ID" Font-Bold="True" Font-Names="Times New Roman" Font-Size="Large" ForeColor="#000066"></asp:Label>
                     <strong>:</strong></td>
                 <td class="auto-style2">
                     <asp:TextBox ID="TxtDrId" runat="server" Width="170px"></asp:TextBox>
                 </td>
             </tr>
              <tr>
                 <td class="auto-style4">
              ...
              <tr>
                 <td class="auto-style4">
                     ...
                     <strong>:</strong></td>
                 <td class="auto-style2">
                     <asp:TextBox ID="TxtDrOldPass" runat="server" Width="170px"></asp:TextBox>
                 </td>
             </tr>
             <tr>
             ...
             <tr>
                 ...
                 <td class="auto-style7">
                     <asp:TextBox ID="TxtDrNewPass" runat="server" TextMode="Password" Width="170px"></asp:TextBox>
                 </td>
             </tr>
             <tr>
             ...
             <tr>
                 <td class="auto-style5">
                     ...
                     <strong>:</strong></td>
                 <td class="auto-style7">
                     <asp:TextBox ID="TxtDrConPass" runat="server" TextMode="Password" Width="170px"></asp:TextBox>
                 </td>
             </tr>
             <tr>
             ...
             <tr>
                 <td colspan="2" class="active" style="text-align: center">
                     <br />
                     <asp:Button class="loghov" ID="BtnDrChangePass" runat="server" Text="UPDATE" BackColor="#000099" Font-Bold="True" Font-Size="Large" ForeColor="White" Height="40px" Width="91px" Style="border:medium solid #000099; border-radius:5px; cursor:pointer;" OnClick="BtnDrChangePass_Click" />
                     <br />
                     <br />
                 </td>
             </tr>
