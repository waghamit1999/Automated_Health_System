<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DoctorLogin.aspx.cs" Inherits="MyFinalProject.DoctorLogin" %>
         ...
         <table class="active" align="center" style="padding: 5px;  background-color: #FFFFFF; font-family: 'Times New Roman', Times, serif; width: 397px; height: 298px;">
             <tr>
                 <td colspan="2" class="auto-style6">
                     <br /><i class="fa fa-user-nurse fa-2x"></i>&nbsp;
                     <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Overline="False" Text="DOCTOR LOGIN" Font-Names="Times New Roman" Font-Size="XX-Large"></asp:Label>
                     <br />
                     <br />
                     <br />
                 </td>
             ...
             <tr>
                 ...
                 <td class="auto-style2">
                     <asp:TextBox ID="TxtDoctorId" runat="server" Width="200px"></asp:TextBox>
                 </td>
             </tr>
             <tr>
                 <td colspan="2">&nbsp;</td>
             ...
             <tr>
                 <td colspan="2" class="active" style="text-align: center">
                     ...
                     <br />
                     <asp:Button class="loghov" ID="BtnDoctLogin" runat="server" Text="LOGIN" BackColor="#000099" Font-Bold="True" Font-Size="Large" ForeColor="White" Height="40px" Width="91px" Style="border:medium solid #000099; border-radius:5px;cursor:pointer;" OnClick="BtnDoctLogin_Click" />
                     <br />
                     <br />
                 </td>
             </tr>
