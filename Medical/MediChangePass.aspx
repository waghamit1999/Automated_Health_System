<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MediChangePass.aspx.cs" Inherits="MyFinalProject.Medical.MediChangePass" %>
         ...
         <table class="active" align="center" style="padding: 5px;  background-color: #FFFFFF; font-family: 'Times New Roman', Times, serif; width: 383px; height: 298px;">
             ...
             <tr>
                 <td class="auto-style4">
                     <asp:Label ID="Label2" runat="server" Text="Medical ID" Font-Bold="True" Font-Names="Times New Roman" Font-Size="Large" ForeColor="#000066"></asp:Label>
                     <strong>:</strong></td>
                 <td class="auto-style2">
                     <asp:TextBox ID="TxtMediId" runat="server" Width="170px"></asp:TextBox>
                 </td>
             </tr>
              <tr>
                 <td class="auto-style4">
              ...
              <tr>
                 <td class="auto-style4">
                     ...
                     <strong>:</strong></td>
                 <td class="auto-style2">
                     <asp:TextBox ID="TxtMediOldPass" runat="server" Width="170px"></asp:TextBox>
                 </td>
             </tr>
             <tr>
             ...
             <tr>
                 ...
                 <td class="auto-style7">
                     <asp:TextBox ID="TxtMediNewPass" runat="server" TextMode="Password" Width="170px"></asp:TextBox>
                 </td>
             </tr>
             <tr>
             ...
             <tr>
                 <td class="auto-style5">
                     ...
                     <strong>:</strong></td>
                 <td class="auto-style7">
                     <asp:TextBox ID="TxtMediConPass" runat="server" TextMode="Password" Width="170px"></asp:TextBox>
                 </td>
             </tr>
             <tr>
             ...
             <tr>
                 <td colspan="2" class="active" style="text-align: center">
                     <br />
                     <asp:Button class="loghov" ID="BtnMediChangePass" runat="server" Text="UPDATE" BackColor="#000099" Font-Bold="True" Font-Size="Large" ForeColor="White" Height="40px" Width="91px" Style="border:medium solid #000099; border-radius:5px; cursor:pointer;" OnClick="BtnMediChangePass_Click"/>
                     <br />
                     <br />
                 </td>
             </tr>
