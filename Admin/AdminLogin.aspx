<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminLogin.aspx.cs" Inherits="MyFinalProject.AdminLogin" %>
         ...
         <table class="active" align="center" style="padding: 5px;  background-color: #FFFFFF; font-family: 'Times New Roman', Times, serif; width: 383px; height: 298px;">
             <tr>
                 <td colspan="2" class="auto-style6">
                     ...
                     <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Overline="False" Text="ADMIN LOGIN" Font-Names="Times New Roman" Font-Size="XX-Large"></asp:Label>
                     <br />
                     <br />
                 </td>
             </tr>
             <tr>
                 <td class="auto-style4">
                     <asp:Label ID="Label2" runat="server" Text="ADMIN ID" Font-Bold="True" Font-Names="Times New Roman" Font-Size="Large" ForeColor="#000066"></asp:Label>
                     <strong>:</strong></td>
                 <td class="auto-style2">
                     <asp:TextBox ID="txtAdminId" runat="server" Width="170px"></asp:TextBox>
                 </td>
             </tr>
             <tr>
             ...
             <tr>
                 ...
                 <td class="auto-style7">
                     <asp:TextBox ID="txtAdminPass" runat="server" TextMode="Password" Width="170px"></asp:TextBox>
                 </td>
             </tr>
             <tr>
             ...
             <tr>
                 <td colspan="2" class="active" style="text-align: center">
                     ...
                     <br />
                     <asp:Button class="loghov" ID="ButtonAdminLogin" runat="server" Text="LOGIN" BackColor="#000099" Font-Bold="True" Font-Size="Large" ForeColor="White" Height="40px" Width="91px" Style="border:medium solid #000099; border-radius:5px; cursor:pointer;" OnClick="ButtonAdminLogin_Click" />
                     <br />
                     <br />
                     <br />
                 </td>
